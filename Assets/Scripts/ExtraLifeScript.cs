...
public class ExtraLifeScript : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D otherCollider)
    {
        ...
        {
            otherCollider.gameObject.SendMessage("ExtraLife");
            GameObject.Find("AudioPlayer").GetComponent<AudioSource>().PlayOneShot(powerupSound, .3f);
            GameObject.Find("GameplayHandler").SendMessage("IncreaseScore", 3000);
            ...
            newTinyCanvas.transform.GetComponentInChildren<UnityEngine.UI.Text>().text = "3000";
